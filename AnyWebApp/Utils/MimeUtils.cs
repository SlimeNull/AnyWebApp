...
namespace AnyWebApp.Utils
{
    ...
    {
        public static Dictionary<string, string> Extensions { get; } = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            { ".323", "text/h323" },
            { ".3g2", "video/3gpp2" },
            { ".3gp", "video/3gpp" },
        ...
        public static bool TryGetMimeType(string filename, [NotNullWhen(true)] out string? mimeType)
        {
            ...
            return Extensions.TryGetValue(filename, out mimeType);
        }
    }
}
